...
% \thanks{T. Tao is supported by a grant from the MacArthur
% Foundation, by NSF grant DMS-0649473, and by the NSF Waterman
% award.}
...
Let
$$
K=\frac{-\partial u}{\partial y}\cos\theta+\frac{\partial u}{\partial x}\sin\theta,
$$
$$
M=\frac{\partial u}{\partial y}\sin\theta+\frac{\partial u}{\partial x}\cos\theta.
$$
Then
$$
\begin{pmatrix}
